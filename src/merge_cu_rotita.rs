...
async fn main(_spawner: Spawner) {
    ...
    let mut last_wheel_pos: Option<i8> = None; // Inlocuit last_touched
    ...
    loop {
        ...
        // ==== TOUCH HANDLING: IPOD CLICK-WHEEL ====
        let mut buf = [0u8; 2];
        ...
        Timer::after_millis(10).await; // Loop-ul respira mult mai rapid acum
    }
}
